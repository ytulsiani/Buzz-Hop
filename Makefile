...
OFILES = main.o Title.o Gameplay.o End.o Buzz.o Professor.o Dawg.o mylib.o font.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = Title.h Gameplay.h End.h Buzz.h Professor.h Dawg.h mylib.h font.h
